...
def main():
    ...
    now_wat   = datetime.now(WAT)               # fixed: was broken HTTP link
    ...
    for symbol in SYMBOLS:
        ...
        # Pass bias into strategy so it can gate conflicting signals
        signal, last1h, sig_type, sl, tp = generate_signal(df_1h, df_1d, bias)
        ...
        if run_mode == "normal":
            ...
            if current_signal == get_last_signal(symbol):
                continue   # deduplicate — already alerted this signal
